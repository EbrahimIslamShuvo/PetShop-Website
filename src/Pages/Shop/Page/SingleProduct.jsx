...
const SingleProduct = () => {
    ...
    const filterProduct = products?.find(product => product.product_id === Number(id))
                        ...
                        <div class="w-full">
                            <div>
                                ...
                                <div class="flex items-center flex-wrap gap-4 mt-6">
                                    <h4 class="text-slate-900 text-2xl sm:text-3xl font-semibold">${filterProduct?.discount_price}</h4>
                                    <p class="text-slate-500 text-lg"><strike>${filterProduct?.price}</strike> <span class="text-sm ml-1.5">Tax included</span></p>
                                </div>

                                <div class="flex items-center gap-4 mt-4">
                                    <div class="flex items-center gap-1 text-lg px-2.5 bg-green-600 text-white rounded-full">
                                        <p>{filterProduct?.rating}</p>
                                    ...
                                    <p class="text-slate-500 text-sm">{filterProduct?.rating} ratings</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center flex-wrap gap-4 mt-4">
                                    <h4 class="text-2xl sm:text-3xl text-slate-900 font-semibold">{filterProduct?.rating} / 5</h4>
                                    <p class="text-sm text-slate-500">Based on {filterProduct?.rating_count} ratings</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-6">
                                {
                                    filterProduct?.reviews.map(review => (
                                        <div class="flex items-start">
                                            <img src={review?.image} class="w-12 h-12 rounded-full border-2 border-white" />
                                            <div class="ml-3">
                                                <h4 class="text-slate-900 text-sm font-semibold">{review?.name}</h4>
                                                ...
                                                <p class="text-sm text-slate-500 mt-4">{review?.description}</p>
                                            </div>
                                        </div>
                                    ))
                                }
