            ...
            <div className="w-10/12 lg:w-full mx-auto mt-10 border border-gray-300 rounded-2xl shadow p-13">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-6 group pb-6 border-b border-gray-300">
                        <div className="border border-gray-300 rounded-xl duration-300 group-hover:bg-orange-400 group-hover:text-white  flex justify-center p-3 text-center">
                            <FaPhoneAlt className='text-2xl' />
                        </div>
                        <div className=" ">
                            <h1 className='font-semibold text-lg'>Phone Number & Email</h1>
                            <h4>+88 01648438489</h4>
                            <h4>ebrahimislam2003@gmail.com</h4>
                        </div>
                    </div>
                    <div className="flex items-center gap-6 group pb-6 border-b border-gray-300">
                        <div className="border border-gray-300 rounded-xl duration-300 group-hover:bg-orange-400 group-hover:text-white  flex justify-center p-3 text-center">
                        ...
                        <div className=" ">
                            <h1 className='font-semibold text-lg'>Our Shop Address</h1>
                            <h4>Banashee, Rampura, Dhaka</h4>
                        </div>
                    </div>
                    <div className="flex items-center gap-6 group">
                        ...
                        <div className=" ">
                            <h1 className='font-semibold text-lg'>Shop Time</h1>
